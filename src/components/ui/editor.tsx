...
export function EditorContainer({
  ...
  return (
    <PlateContainer
      className={cn(
        // A marker, not a style. The report page has to put `touch-action` on
        // the box WRAPPING the editable as well as on the editable itself, and
        // it used to find that box with `:has(> [data-slate-editor])` — a
        // `:has()` whose subject is every descendant of the report page, and
        // whose argument is an attribute, so the browser re-evaluates it
  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        report: "size-full px-2 py-2 text-[18px] leading-normal",
        none: "",
